<template>
  <div class="body">
    ...
    <h1>手写数字识别</h1>
    <vue-esign ref="esign" :width="300" :height="300" :isCrop="isCrop" :lineWidth="lineWidth" :lineColor="lineColor" :bgColor.sync="bgColor" style="border: 2px solid black; border-radius: 10px;margin: auto"/>
    <br/>
...
<script>
import { uploadImg } from '@/api/ai/utils/AIUtil'
